...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Senior AI Product Leader. Delivery frameworks, governance architecture, and the instincts behind getting enterprise AI into production reliably. Based in Paris." },
      { property: "og:title", content: "Ashish Sinha — Enterprise AI Product Leader" },
      { property: "og:description", content: "Senior AI Product Leader. Delivery frameworks, governance architecture, and the instincts behind getting enterprise AI into production reliably. Based in Paris." },
    ...
    scripts: [
      { src: "https://platform.linkedin.com/badges/js/profile.js", async: true, defer: true, type: "text/javascript" },
    ],
  }),
